...
extensions = [
    Extension("sumo-api/sumo/base/*",
              sources=["sumo-api/sumo/base/*.pyx"],
    ...
    Extension("sumo-api/sumo/geometry/*",
              sources=["sumo-api/sumo/geometry/*.pyx"],
    ...
    Extension("sumo-api/sumo/opencv/*",
              sources=["sumo-api/sumo/opencv/*.pyx"],
              library_dirs =["/usr/local/Cellar/opencv/3.4.1/lib",
                            '/usr/local/Cellar/boost/1.66.0/lib/'],
              include_dirs=[numpy.get_include(),
                            ".",
    ...
    Extension("sumo-api/sumo/images/*",
              sources=["sumo-api/sumo/images/*.pyx",
                       "sumo-api/sumo/images/RgbdTiff.cpp",
                       "sumo-api/sumo/images/Rgbdci360.cpp"],
              library_dirs =["/usr/local/Cellar/opencv/3.4.1/lib",
                            '/usr/local/Cellar/boost/1.66.0/lib/'],
              include_dirs=[numpy.get_include(),
                            ".",
    ...
    Extension("sumo-api/sumo/threedee/*",
              sources=["sumo-api/sumo/threedee/*.pyx",
                       "sumo-api/sumo/threedee/Mesh.cpp",
                       "sumo-api/sumo/threedee/TexturedMesh.cpp",
                       "sumo-api/sumo/threedee/GltfModel.cpp",
                       "sumo-api/sumo/threedee/tinyply/tinyply.cpp",
                       "sumo-api/sumo/threedee/point_cloud_ply_c.cpp"],
              library_dirs =["/usr/local/Cellar/opencv/3.4.1/lib",
                            '/usr/local/Cellar/boost/1.66.0/lib/'],
              include_dirs=[numpy.get_include(),
                            ".",
    ...
    # Extension("sumo-api/sumo/semantic/*",
    #           sources=["sumo-api/sumo/semantic/*.pyx",],
    #           library_dirs =["/usr/local/Cellar/opencv/3.4.1/lib",
    #                         '/usr/local/Cellar/boost/1.66.0/lib/'],
    #           include_dirs=[numpy.get_include(),
    #                         ".",
